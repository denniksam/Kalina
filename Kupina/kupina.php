...
class Kupina {
	...
	public function self_test( $echo = false ) {
		$ret = true ;
		$res = $this->digest( "000102030405060708090A0B0C0D0E0F101112131415161718191A1B1C1D1E1F202122232425262728292A2B2C2D2E2F303132333435363738393A3B3C3D3E3F", "HEX" )
				== "08F4EE6F1BE6903B324C4E27990CB24EF69DD58DBE84813EE0A52F6631239875" ;
		$ret &= $res ;
		if( $echo ) {
			echo "N = 512: " . ( $res ? "passed" : "failed" ) ;
		}
		else {
			if( ! $ret ) return false ;
		}
		$res = $this->digest( "", "HEX" )
				== "0A9474E645A7D25E255E9E89FFF42EC7EB31349007059284F0B182E452BDA882" ;
		$ret &= $res ;
		if( $echo ) {
			echo "N = 1024: " . ( $res ? "passed" : "failed" ) ;
		}
		else {
			if( ! $ret ) return false ;
		}
		$res = $this->digest( "", "HEX" )
				== "D305A32B963D149DC765F68594505D4077024F836C1BF03806E1624CE176C08F" ;
		$ret &= $res ;
		if( $echo ) {
			echo "N = 2048: " . ( $res ? "passed" : "failed" ) ;
		}
		else {
			if( ! $ret ) return false ;
		}
		$res = $this->digest( "FF", "HEX" )
				== "EA7677CA4526555680441C117982EA14059EA6D0D7124D6ECDB3DEEC49E890F4" ;
		$ret &= $res ;
		if( $echo ) {
			echo "N = 8: " . ( $res ? "passed" : "failed" ) ;
		}
		else {
			if( ! $ret ) return false ;
		}
		$res = $this->digest( "000102030405060708090A0B0C0D0E0F101112131415161718191A1B1C1D1E1F202122232425262728292A2B2C2D2E2F303132333435363738393A3B3C3D3E3F404142434445464748494A4B4C4D4E4F505152535455565758595A5B5C5D5E", "HEX" )
				== "1075C8B0CB910F116BDA5FA1F19C29CF8ECC75CAFF7208BA2994B68FC56E8D16" ;
		$ret &= $res ;
		if( $echo ) {
			echo "N = 760: " . ( $res ? "passed" : "failed" ) ;
		}
		else {
			if( ! $ret ) return false ;
		}
