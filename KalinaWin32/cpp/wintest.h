...
#define MSGBTNACT_TERMINATE		1
#define MSGBTNACT_CLOSEWIN		2

#define KEY_STATUS_EMPTY		0
#define KEY_STATUS_REJECTED		2
#define KEY_STATUS_ACCEPTED		4
