function Kalina(b,k){
    ...
    /*(s){
        ...
        var i,u,r="",l=s.length;
        for(i=0;i<l;i++){
            u=s.charCodeAt(i);
            if(u<0x0080)r+=String.fromCharCode(u);
            else if(u<0x0800)r+=String.fromCharCode(0xC0|(u>>6))+String.fromCharCode(0x80|(u&0x3F));
            else if(u<0x10000)r+=String.fromCharCode(0xE0|(u>>12))+String.fromCharCode(0x80|((u>>6)&0x3F))+String.fromCharCode(0x80|(u&0x3F));
    ...
    function utf8decompose(u){
        ...
        var i,c,r="",l=u.length;
        i=0;
        do{
            c=u.charCodeAt(i);
            if(c<128){r+=String.fromCharCode(c);i++;}
            else{
                if(c<224){r+=String.fromCharCode((c-192)*64 + (u.charCodeAt(i+1)-128));i+=2;}
                else if (c<240){r+=String.fromCharCode((c-224)*64*64 +(u.charCodeAt(i+1)-192)*64 + (u.charCodeAt(i+2)-128));i+=3;}
            }
        }while(i<l);
        return r;*/
        var string = u.replace(/\r\n/g,"\n");
		var utftext = "";
